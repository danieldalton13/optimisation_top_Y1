...
% Updated for 9 nodes wide and 3 nodes tall structure with 10 kN loads
LoadNodes = [3, 6, 9, 12, 15, 18, 21, 24, 27];
LoadMagnitudes = [10, 10, 10, 10, 10, 10, 10, 10, 10];

% Generate the structured orthogonal domain
% Updated Nx=8 (9 nodes wide), Ny=2 (3 nodes tall), Lx=4, Ly=1

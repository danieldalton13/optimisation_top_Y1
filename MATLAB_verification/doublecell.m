...
% Updated for 5 nodes wide and 3 nodes tall structure with 10 kN loads
LoadNodes = [3, 6, 9, 12, 15];
LoadMagnitudes = [10, 10, 10, 10, 10];

% Generate the structured orthogonal domain
% Updated Nx=4 (5 nodes wide), Ny=2 (3 nodes tall), Lx=3, Ly=1
[NODE, ELEM, SUPP, LOAD, BARS] = StructDomain(4, 2, 4, 2, 'bridge', LoadNodes, LoadMagnitudes);
...
% Updated movable nodes based on the new structure
movableNodesX = [5, 9, 13];
movableNodesY = [3, 6, 9, 12, 15];
